 ...
 */
@WebServlet(name = "Postmeasuredsignalsservlet", urlPatterns = {"/postmeasuredsignals"})
public class PostMeasuredSignalsServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query = " INSERT INTO signalsmeasured (room, Wifis, Cells, point)"
                    + " VALUES (?, ?, ?, ?)";
