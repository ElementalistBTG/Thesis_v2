...
public class FirebaseManager {
    ...
    private static final String TAG = "testDinos";
    private static final String KEY_ROOT_DIR = "points_dir";
    ...
    public void getShortCode(ShortCodeListener listener) {
        rootRef
                .child(KEY_NEXT_SHORT_CODE)
                .runTransaction(
                        new Transaction.Handler() {
                            ...
                            public Transaction.Result doTransaction(MutableData currentData) {
                                ...
                                currentData.setValue(shortCode);
                                return Transaction.success(currentData);
                            }
